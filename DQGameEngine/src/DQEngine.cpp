...
int Test()
{
    ...
    unsigned char* data = stbi_load("assets/images/tilemap/Run.png", &texW, &texH, &texChannels, 4); // force RGBA
    if (!data) {
...
int Test1()
{
    ...
    SDL_Window* window = SDL_CreateWindow("AMD Alpha Test", 800, 600, SDL_WINDOW_OPENGL);
    SDL_GLContext context = SDL_GL_CreateContext(window);
    ...
    unsigned char* data = stbi_load("assets/images/tilemap/Run.png", &w, &h, &ch, 4);
    if (!data) {
