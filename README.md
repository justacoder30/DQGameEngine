...
Textures are shared between the cache, sprites, and animations.
...
together. 
Existing code must qualify engine names or use `using namespace
dqengine;` in its own source files. 
Sandbox uses `Engine.h` for this convenience.
...
- **IDE:** Visual Studio 2026 with **Desktop development with C++** workload installed.
